module.exports.exec = async (bot, message, args) => {
    ...
    if (!tokenData) {// tokenData does not exist yet, create new one
        ...
        if (tokenData.token == playerData.realname.trim()) {
            ...
            bot.logToDB(message.member.id, message.createdTimestamp, "STEAM_TOKEN_VERIFIED_SUCCESS", [member.user.username + " has verified his token successfully", token], message.guild);
